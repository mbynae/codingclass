<?php
    ...
    $sql .=     "HosCategory varchar(10) NOT NULL,";
    $sql .=     "HosName varchar(10) NOT NULL,";
    $sql .=     "HosAdress longtext NOT NULL,";
    $sql .=     "HosCon1 varchar(100) DEFAULT NULL,";
    $sql .=     "HosCon2 varchar(100) DEFAULT NULL,";
    $sql .=     "HosImgFile varchar(100) DEFAULT NULL,";
    $sql .=     "HosTime varchar(20) NOT NULL,";
    $sql .=     "HosSpecialty1 varchar(10) NOT NULL,";
    $sql .=     "HosSpecialty2 varchar(10) NOT NULL,";
