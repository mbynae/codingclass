const allMusic = [
    {
        name: "1. Lover Forever",
        artist: "PARUN",
        img: "game_music_icon01",
        audio: "music_audio01"
    },
    {
        name: "2. Crystal Ocean",
        artist: "Riya & Neple",
        img: "game_music_icon02",
        audio: "music_audio02"
    },
    {
        name: "3. Stay With Me",
        artist: "Artifact",
        img: "game_music_icon03",
        audio: "music_audio03"
    },
    {
        name: "4. another world",
        artist: "orion",
        img: "game_music_icon04",
        audio: "music_audio04"
    },
    {
        name: "5. Wasted My Time",
        artist: "Komua",
        img: "game_music_icon05",
        audio: "music_audio05"
    },
    {
        name: "6. Good_Times",
        artist: "작자미상",
        img: "game_music_icon06",
        audio: "music_audio06"
    },
    {
        name: "7.Sand_Castles",
        artist: "작자미상",
        img: "game_music_icon07",
        audio: "music_audio07"
    },
    {
        name: "8. Festival",
        artist: "작자미상",
        img: "game_music_icon08",
        audio: "music_audio08"
    },
    {
        name: "9. Bike_Rides",
        artist: "작자미상",
        img: "game_music_icon09",
        audio: "music_audio09"
    },
    {
        name: "10. Get_Outside",
        artist: "작자미상",
        img: "game_music_icon10",
        audio: "music_audio10"
    }
];
...
function loadMusic(num){
    ...
    musicView.src = `../assets/img/${allMusic[num-1].img}.png`;         //뮤직 앨범 이미지 로드
    musicView.alt = allMusic[num-1].name;                               //뮤직 앨범 alt 로드
...
function playListMusic(){
    ...
    for(let i=0; i<musicListAll.length; i++){
        ...
        if(musicListAll[i].classList.contains("playing") == true){
...
//뮤직 리스트 버튼 클릭시
musicListBtn.addEventListener("click", () => {
    if(musicList.classList.contains("close") == true){
        musicList.classList.remove("close");
    } else {
        musicList.classList.add("close");
    }
});

const listCloseBtn = musicWrap.querySelector(".music__list h3 a");
