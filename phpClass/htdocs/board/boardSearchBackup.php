...
<?php
    ...
    switch($searchOption){
        case 'title';
            $sql .= "WHERE b.boardTitle LIKE '%{$searchKeyword}%' ORDER BY myBoardID DESC LIMIT 10"; //= 앞에 .은 플러스 의미
            break;
...
<?php
    ...
    if($page != $endPage){
        $naxtPage = $page + 1;
        echo "<li><a href='boardSearch.php?searchKeyword={$searchKeyword}&searchOption={$searchOption}&page={$naxtPage}'>다음</a></li>";
